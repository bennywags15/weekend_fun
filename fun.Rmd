...
eighteen %>% 
  ...
  labs(title = "Non-medical drug use by college students age 18-24 in 2018", x = "", y = "", caption = "Totals out of 1,277 college students age 18-24 surveyed in 2018") +
  theme(plot.title = element_text(size = 14, face = "bold", hjust = -3.8, colour = "Black"),
