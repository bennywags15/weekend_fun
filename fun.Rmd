...
eighteen <- us_18Q1 %>% 
  ...
  mutate(any_chronic = (PAIN_CHRONIC != 1),
         ...
         Black = (DEM_RACE == 2),
         Asian = (DEM_RACE == 3),
         Indian_or_Native = (DEM_RACE == 4),
         Hawaii_or_PI = (DEM_RACE == 5))
```
...
glm_fit4 <- glm(any_nmu_numeric ~ COLLEGE_GREEK + DEM_GENDER + any_chronic + any_alc, data = eighteen, family = binomial)
summary(glm_fit4)
