...
glm_fit4 <- glm(any_nmu_numeric ~ COLLEGE_GREEK + DEM_GENDER + any_chronic + any_alc + rxsafe +any_mental, data = eighteen, family = binomial)
summary(glm_fit4)
...
glm_fit7 <- glm(any_nmu_numeric ~ Hawaii_or_PI, data = eighteen, family = binomial)
summary(glm_fit7)

glm_fit8 <- glm(any_nmu_numeric ~ rxsafe, data = eighteen, family = binomial)
summary(glm_fit8)

glm_fit9 <- glm(any_nmu_numeric ~ acute_pain, data = eighteen, family = binomial)
summary(glm_fit9)
